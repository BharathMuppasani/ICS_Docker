...
to export
  export-world "/home/data/state/world.csv"
end

to import
  import-world "/home/data/state/world.csv"
end
...
to create-nb-basic-agents
  ...
  ifelse not file-exists? "/home/data/input/basicAgentsInput.csv" [
    user-message "No file '/home/data/input/basicAgentsInput.csv' exists. Skipping to next agent type."
  ][
    file-open "/home/data/input/basicAgentsInput.csv" ; open the file with the turtle data
...
to create-nb-spokesperson-agents
  file-close-all ; close all open files
  ifelse not file-exists? "/home/data/input/spokespersonAgentsInput.csv" [
    user-message "No file '/home/data/input/spokesperson-agents-input.csv' exists. Skipping to next agent type."
  ][
    file-open "/home/data/input/spokespersonAgentsInput.csv" ; open the file with the turtle data
    let data (csv:from-row file-read-line "~")
    ; We'll read all the data in a single loop
...
to create-nb-donovian-agents
  file-close-all ; close all open files
  ifelse not file-exists? "/home/data/input/donovianAgentsInput.csv" [
    user-message "No file '/home/data/input/donovianAgentsInput.csv' exists. Skipping to next agent type."
  ][
    file-open "/home/data/input/donovianAgentsInput.csv" ; open the file with the turtle data
    let data (csv:from-row file-read-line "~")
    ; We'll read all the data in a single loop
...
to create-nb-information-diss-agents
  file-close-all ; close all open files
  ifelse not file-exists? "/home/data/input/InfoDissAgents.csv" [
    user-message "No file '/home/data/input/InfoDissAgents.csv' exists. Skipping Information Dissemination Agents."
  ][
    file-open "/home/data/input/InfoDissAgents.csv" ; open the file with the turtle data
    let data (csv:from-row file-read-line "~")
    ; We'll read all the data in a single loop
...
to create-nb-flow-manipulator-agents
  file-close-all ; close all open files
  ifelse not file-exists? "/home/data/input/flowManipulatorAgentsInput.csv" [
    user-message "No file '/home/data/input/flowManipulatorAgentsInput.csv' exists. Skipping Flow Manipulator Agents."
  ][
    file-open "/home/data/input/flowManipulatorAgentsInput.csv" ; open the file with the turtle data
    let data (csv:from-row file-read-line "~")
    ; We'll read all the data in a single loop
    while [ not file-at-end? ] [
      ; here the CSV extension reads a single line and puts the read data in a list
...
to create-nb-live-agents
  file-close-all ; close all open files
  ifelse not file-exists? "/home/data/input/liveAgentsInput.csv" [
    user-message "No file '/home/data/input/liveAgentsInput.csv' exists. Skipping Flow Manipulator Agents."
  ][
    file-open "/home/data/input/liveAgentsInput.csv" ; open the file with the turtle data
    let data (csv:from-row file-read-line "~")
    ; We'll read all the data in a single loop
...
to setup-IP
  file-close-all ; close all open files
  if not file-exists? "/home/data/input/IPsInput_tick_0.csv" [
    print "No file '/home/data/input/IPsInput_tick_0.csv' exists."
    stop
  ]
  file-open "/home/data/input/IPsInput_tick_0.csv" ; open the file with the turtle data
...
to make-connections
  file-close-all ; close all open files
  if not file-exists? "/home/data/input/adjacency_matrix.csv" [
    user-message "No file '/home/data/input/adjacency_matrix.csv' exists."
    stop
  ]
  let ids_list []
  file-open "/home/data/input/adjacency_matrix.csv" ; open the file with the links data
                                                  ; We'll read all the data in a single loop
...
to get-next-IPs
  ...
  file-close-all ; close all open files
  let ipfile word "/home/data/input/IPsInput_tick_" tick-count
...
;    let infoAct  word "/home/data/output/information-actions-tick-" tick-count
...
to track_agents
  ...
  let agent_track_file  word "/home/data/output/track_agents_" tick-count
...
to track_triads
  ...
  let triad_track_file  word "/home/data/output/track_triads_" tick-count
...
to create_logs
  let infoAct  word "/home/data/output/information-actions-tick-" tick-count
    set infoAct (word infoAct "_" simulation_id)
    (csv:to-file word infoAct".csv" Information_Action_list "~")
    let trackID  word "/home/data/output/identity_action_tick_" tick-count
    set trackID (word trackID "_" simulation_id)
    (csv:to-file word trackID ".csv" identity-list "~")
    let relAct  word "/home/data/output/realtionship_action_tick_" tick-count
